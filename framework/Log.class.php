...
class Log {
    ...
    static public function init($config=array()){
        ...
        $class  =   strpos($type,'\\')? $type: 'framework\\log\\driver\\'. ucwords(strtolower($type));           
        unset($config['type']);
     ...
     * @return void
     */
    static function record($message,$level=self::ERR,$record=true) {
    ...
    static function save($type='',$destination='') {
        ...
        if(!self::$storage){
            ...
            $class  =   'framework\\log\\driver\\'. ucwords($type);
